...
export function getTrackedMicroTypes(): MicroType[] {
  ...
  let parameter1 = new Parameter(1, "Greet with Handshake", "Greet_with_handshake", "Set whether the robot extends its arm for a handshake", "bool");
  let microGreeter = new MicroType("Greeter", [parameter0, parameter1]);
  ...
  //handoff
  // ** This uses new preferred way of adding parameters to a micro **
  let microHandoff = new MicroType("Handoff", [
    new Parameter(2, "Robot Speaks", "robot_speaks", "Robot speaks during handoff", "bool")
  ]);
